...
export const INITIAL_HUMAN_DOCTORS: Doctor[] = [
  ...
  // ─── Kolkata New Town Area Doctors ─────────────────────────────
  {
    ...
    rating: 4.9,
    reviewsCount: 287,
    location: "Apollo Clinic, Action Area 1, New Town, Kolkata",
    availability: "Available Now",
    image: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80&w=300&h=300",
    onlineStatus: "online",
    bio: "Dr. Arjun Banerjee is a leading interventional cardiologist in Kolkata specializing in coronary angioplasty, heart failure management, and preventive cardiology. He has performed 2000+ procedures.",
    verified: true,
    coordinates: { lat: 22.5801, lng: 88.4750 },
  },
  {
    id: 12,
    name: "Dr. Shreya Mukherjee",
    title: "MD (Pediatrics), DNB",
    specialty: "Pediatrics",
    experience: 10,
    rating: 4.8,
    reviewsCount: 156,
    location: "Motherhood Clinic, Eco Park Road, New Town, Kolkata",
    availability: "Next slots: 3:00 PM",
    image: "https://images.unsplash.com/photo-1594824432258-f9011b0e0084?auto=format&fit=crop&q=80&w=300&h=300",
    onlineStatus: "online",
    bio: "Dr. Shreya Mukherjee is a compassionate pediatrician providing comprehensive child healthcare, neonatal care, immunization programs, and developmental milestone tracking.",
    verified: true,
    coordinates: { lat: 22.5755, lng: 88.4685 },
  },
  {
    id: 13,
    ...
    rating: 4.7,
    reviewsCount: 410,
    location: "Fortis Hospital, Rajarhat Main Road, New Town, Kolkata",
    availability: "Available Tomorrow",
    image: "https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&q=80&w=300&h=300",
    onlineStatus: "offline",
    bio: "Dr. Debashis Ghosh is one of Eastern India's most experienced orthopedic surgeons, specializing in total knee replacements, spinal surgery, and sports injury management.",
    verified: true,
    coordinates: { lat: 22.5690, lng: 88.4820 },
  },
  {
    id: 14,
    name: "Dr. Priya Sen",
    title: "MD (Dermatology), FRCP",
    specialty: "Dermatology",
    experience: 8,
    rating: 4.9,
    reviewsCount: 198,
    location: "Glow Skin & Hair Clinic, Biswa Bangla Gate, New Town, Kolkata",
    availability: "Available Now",
    image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&q=80&w=300&h=300",
    onlineStatus: "online",
    bio: "Dr. Priya Sen is an award-winning dermatologist specializing in laser treatments, acne scar revision, anti-aging therapies, and autoimmune skin disorders.",
    verified: true,
    coordinates: { lat: 22.5725, lng: 88.4610 },
  },
  {
    id: 15,
    name: "Dr. Saurav Chatterjee",
    title: "MD, Ph.D. (Neurology)",
    specialty: "Neurology",
    experience: 19,
    rating: 4.8,
    reviewsCount: 223,
    location: "AMRI Hospital, Mukundapur, Near New Town, Kolkata",
    availability: "Next slots: 11:00 AM",
    image: "https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=300&h=300",
    onlineStatus: "online",
    bio: "Dr. Saurav Chatterjee is a renowned neurologist specializing in stroke management, epilepsy treatment, movement disorders, and neurodegenerative disease research.",
    verified: true,
    coordinates: { lat: 22.5650, lng: 88.4900 },
  },
  {
    id: 16,
    name: "Dr. Rina Das",
    ...
    rating: 4.7,
    reviewsCount: 312,
    location: "Bloom Women's Clinic, City Centre 2, New Town, Kolkata",
    availability: "Available Now",
    image: "https://images.unsplash.com/photo-1591604466107-ec97de577aff?auto=format&fit=crop&q=80&w=300&h=300",
    onlineStatus: "online",
    bio: "Dr. Rina Das provides expert care in high-risk pregnancies, infertility management, laparoscopic surgeries, and adolescent gynecology at her state-of-the-art clinic.",
    verified: true,
    coordinates: { lat: 22.5780, lng: 88.4560 },
  }
];
